...
public class Carrito {
    ...
    public Carrito(String titulo_cuadro, String artista, String descripcion, String ano_realizacion, String genero, Double precio) {
    ...
    public void setAno_realizacion(String ano_realizacion) {
        this.ano_realizacion = ano_realizacion;
    }
